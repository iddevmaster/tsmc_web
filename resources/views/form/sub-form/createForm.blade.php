    ...
    <div class="container py-4" x-data="formBuilder()">
        <form @submit.prevent="handleSubmit" class="vstack gap-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <input type="text" x-model="formTitle" placeholder="ชื่อฟอร์มย่อย"
            ...
            <div class="d-flex justify-content-center gap-2">
                <a href="{{ route('form.table', ['form_category' => 'sub-form']) }}">
                    <button type="button"
                        ...
                        .then(data => {
                            ...
                            if (data.errors) {
                                ...
                                Swal.fire(data.success ? data.success :"บันทึกสำเร็จ", "", "success").then(() => {
                                    window.location.href = "{{ route('form.table', ['form_category' => 'sub-form']) }}";
                                });
                            }
                        })
                        .catch(error => {
